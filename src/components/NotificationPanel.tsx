    ...
    const demoNotifications: Notification[] = [
      {
        ...
        type: 'weather',
        title: 'Weather Alert',
        message: 'Heavy rain expected tomorrow. Consider harvesting ready crops and protecting seedlings.',
        time: '2 hours ago',
        isRead: false,
        priority: 'high'
      },
      {
        ...
        message: 'Your order KM123456 (Paddy Seeds 1010) has been successfully delivered.',
        time: '4 hours ago',
        isRead: false,
        priority: 'medium'
      },
      {
        ...
        message: 'PM-KISAN subsidy of ₹2,000 has been credited to your account. Check your wallet.',
        time: '1 day ago',
        isRead: true,
        priority: 'medium'
      },
      {
        ...
        message: 'Paddy prices increased by 8% in Hyderabad market. Current rate: ₹2,850/quintal.',
        time: '1 day ago',
        isRead: false,
        priority: 'low'
      },
      {
        ...
        type: 'order',
        title: 'Order Shipped',
        message: 'Your order KM789012 (Cotton Seeds) is out for delivery. Expected by tomorrow.',
        time: '2 days ago',
        isRead: true,
        priority: 'medium'
      },
      {
        ...
        message: 'Soil moisture levels are optimal for wheat sowing in your region.',
        time: '3 days ago',
        isRead: true,
        priority: 'low'
      },
      {
        ...
        message: 'Your application for agricultural equipment subsidy has been approved. Amount: ₹15,000.',
        time: '1 week ago',
        isRead: true,
        priority: 'high'
      },
      {
        ...
        message: 'Organic vegetables showing 15% price increase. Consider transitioning to organic farming.',
        time: '1 week ago',
        isRead: false,
        priority: 'low'
      }
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          {notification.type === 'market' ? 'Market Insights' : notification.type}
                        </Badge>
